...
namespace Yinyang.Utilities.SQLite
{
    public class Sqlite : IDisposable
    {
        ...
        /// <summary>
        /// Gets or sets the string used to open a SQLite database.
        /// </summary>
...
        public string CommandText
        ...
        public Sqlite()
        {
            ...
            _sqlCommand = new SqliteCommand { Connection = _sqlConnection };
        }
...
        public Sqlite Copy()
        {
            return new Sqlite(_connectionString);
        }
...
        public void AddParameter(string key, object obj)
        {
            _sqlCommand.Parameters.Add(obj == null
                ? new SqliteParameter(key, DBNull.Value)
                : new SqliteParameter(key, obj));
        }
